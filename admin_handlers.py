# admin_handlers.py - Все админские обработчики (ПОЛНАЯ ИСПРАВЛЕННАЯ ВЕРСИЯ)
...
# ============================================
# РЕДАКТИРОВАНИЕ ТОВАРА (ЦЕНА, НАЗВАНИЕ, КОЛИЧЕСТВО)
# ============================================
...
async def product_change_description_start(callback: CallbackQuery, state: FSMContext):
    ...
    # Используем новую клавиатуру с ID товара
