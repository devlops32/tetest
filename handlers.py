...
# ============================================
# АДМИНКА - ДОБАВЛЕНИЕ ТОВАРА (НОВЫЙ ОБРАБОТЧИК)
# ============================================
...
# ============================================
# АДМИНКА - СТАТИСТИКА ТОВАРОВ (НОВЫЙ ОБРАБОТЧИК)
# ============================================
...
# ============================================
# ОСТАЛЬНЫЕ ОБРАБОТЧИКИ ПОЛЬЗОВАТЕЛЕЙ (сокращены)
# ============================================

# ... (здесь обработчики: users_list, users_page, users_active, users_stats, users_blocked, 
# blocked_page, user_info, user_orders, user_block, user_unblock, user_delete, user_message, mailing)
