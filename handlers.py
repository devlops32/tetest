...
# ... (здесь должны быть user_orders, user_orders_page, user_block, 
# user_confirm_block, user_unblock, user_delete, user_confirm_delete,
# user_message_start, user_message_send, users_mailing, mailing_select, 
# mailing_send, users_back, auto_sell, back_to_admin, back_to_main, page_info)
